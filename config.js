...
global.owner = process.env.OWNER_NUMBER.split('447366274434'); 
global.anitav4 = process.env.BOT_NAME || "GOKU MD-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "AhSaN";
global.packname = process.env.PACK_NAME || "AhSaN-𝐕𝟒";
global.author = process.env.AUTHOR || "AhSaN";
global.channelname = process.env.CHANNEL_NAME || "𝐃𝐀𝐕𝐈𝐃 𝐂𝐘𝐑𝐈𝐋";
global.channeljid = process.env.CHANNEL_JID || "20363315231436175@newsletter1";
